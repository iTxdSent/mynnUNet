...
if __name__ == "__main__":
    source = '/data0/users/liuxiangdong/data/AAV_4seg'

    dataset_name = 'Dataset150_AAV'
    ...
    generate_dataset_json(join(nnUNet_raw, dataset_name), {0: 'R', 1: 'G', 2: 'B'}, {'background': 0, 'AAo': 1,'AoA':2, 'DAo': 3, 'Ishumus': 4},
