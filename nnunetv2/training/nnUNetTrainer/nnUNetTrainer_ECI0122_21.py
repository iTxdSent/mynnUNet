...
class nnUNetTrainer_ECI_0122_21(nnUNetTrainer):
    # ------------------------
    # Reproducibility
    # ------------------------
    seed: int = 2568
    ...
    cudnn_benchmark: bool = False
    allow_tf32: bool = False
    use_deterministic_algorithms: bool = False  # set True only if you can tolerate potential runtime errors

    # ------------------------
    # Hyperparameters (adjust at class level or in __init__)
    # ------------------------
    # ECI feature injection schedule
    eci_inject_warmup_epochs: int = 10
    ...
    edge_supervision_levels: Optional[Sequence[int]] = [-4,-3,-2,-1]  # None -> [last_stage]
